...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-64 flex-col bg-gradient-to-b from-white via-[#F5F2EE]/50 to-white border-r border-gray-100">
      <div className="flex flex-col flex-1 overflow-y-auto px-6 py-8">
        ...
        <div className="mb-8 pb-8 border-b border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            {profile?.avatar_url ? (
              ...
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#CC8800] to-[#38761D] flex items-center justify-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="inline-block mt-1 px-2.5 py-1 rounded-full bg-gradient-to-r from-[#CC8800]/10 to-[#38761D]/10 text-xs font-medium text-primary">
                {roleLabel}
              </span>
            </div>
          </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-white text-[#CC8800] shadow-sm border-l-2 border-[#CC8800]"
        ...
        <div className="mb-6 pt-6 border-t border-gray-100">
          <Link
            ...
            className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-2xl bg-gradient-to-r from-[#CC8800] to-[#A66E00] text-white font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200"
          >
