    ...
    <>
      ...
      <div className="border-t border-gray-100 pt-6 space-y-3">
        <button
          ...
          className="w-full px-4 py-3 bg-gradient-to-r from-[#E07A5F] to-[#D96850] text-white rounded-2xl font-semibold hover:shadow-md transition-all"
        >
          Réserver ce service
        </button>
        <button
          ...
          className={`w-full px-4 py-3 rounded-2xl font-semibold transition-all flex items-center justify-center gap-2 ${
            isFavorite
              ? "bg-gradient-to-r from-[#E07A5F] to-[#D96850] text-white"
