            ...
            <div className="w-full md:w-72 h-64 md:h-auto flex items-center justify-center">
              ...
              >
                ...
                <path
                  ...
                  fill="none"
                />
                <rect x="180" y="110" width="40" height="30" rx="4" fill="#E07A5F" />
                <line x1="70" y1="135" x2="170" y2="135" stroke="#81B29A" strokeWidth="2" />

                {/* Coins/Money elements */}
                <circle cx="60" cy="50" r="12" fill="#81B29A" opacity="0.3" />
                <circle cx="100" cy="40" r="16" fill="#E07A5F" opacity="0.2" />
                <circle cx="200" cy="35" r="14" fill="#81B29A" opacity="0.25" />

                {/* Sparkles */}
                <g opacity="0.6">
                  <circle cx="150" cy="30" r="2" fill="#E07A5F" />
                  <path d="M148 30h4M150 28v4" stroke="#E07A5F" strokeWidth="1" />
                </g>
                <g opacity="0.5">
                  <circle cx="230" cy="70" r="2" fill="#81B29A" />
                  <path d="M228 70h4M230 68v4" stroke="#81B29A" strokeWidth="1" />
                </g>
              </svg>
            </div>
          </div>
